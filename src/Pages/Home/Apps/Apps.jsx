...
const Apps = () => {
    return (
        <div>
            <section>
                <div className="px-4 py-8 md:pl-20" data-aos="fade-right" data-aos-easing="ease-out-cubic"
                    ...
                    Now you can get our amazing Mobile App in both play store and App Store. Please use the app for get better user experience.
                    </p>
